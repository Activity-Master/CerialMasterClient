...
- Library name: Cerial Master Client
- Current/new version: <VERSION>
- Repository URL / path: https://github.com/Activity-Master/CerialMasterClient.git
- Rules Repository Location: https://github.com/GuicedEE/ai-rules.git
- Rules Repository target path for generated artifacts (relative to the Rules Repository root): generative/data/activity-master/cerial-client
- Short description: The client library for the Cerial Master System addon for the Activity Master FSDM
- Type:
